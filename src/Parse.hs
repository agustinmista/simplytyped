...
action_9 (20) = happyShift action_22
...
action_36 (19) = happyShift action_34
...
happyNewToken action sts stk
	...
	case tk of {
	TokEOF -> action 28 28 tk (HappyState action) sts stk;
	TokEquals -> cont 13;
	TokColon -> cont 14;
	TokAbs -> cont 15;
	TokDot -> cont 16;
