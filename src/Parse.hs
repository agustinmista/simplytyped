...
action_19 (13) = happyShift action_27
...
action_21 (14) = happyShift action_25
...
action_32 (17) = happyShift action_29
...
action_34 (16) = happyShift action_36
...
action_36 (8) = happyGoto action_41
...
happyReduction_12 (HappyTerminal (TokVar happy_var_1))
	 =  HappyAbsSyn8
		 (LVar happy_var_1
	)
...
happyNewToken action sts stk
	...
	case tk of {
	TokEOF -> action 26 26 tk (HappyState action) sts stk;
	TokEquals -> cont 13;
	TokColon -> cont 14;
	TokAbs -> cont 15;
	TokDot -> cont 16;
	...
	TokClose -> cont 18;
	TokArrow -> cont 19;
	TokVar happy_dollar_dollar -> cont 20;
	TokType -> cont 21;
	TokDef -> cont 22;
	TokLet -> cont 23;
	TokIn -> cont 24;
